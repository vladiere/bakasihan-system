<template>
  <div class="navbar bg-base-100 border-b-2 border-base-200 dark:border-base-200">
    <div class="navbar-start">
      <div class="dropdown">
        <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
          <IconMenuAlt2 classes="h-8 w-8" />
        </div>
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
          ...
          <li> <RouterLink to="/sales">Credit Sales</RouterLink> </li>
        </ul>
      </div>
    </div>
    <div class="navbar-center">
      <RouterLink class="btn btn-ghost text-xl" to="/">Entoy's Bakasihan</RouterLink>
    </div>
    <div class="navbar-end">
      <label class="cursor-pointer grid place-items-center">
        <input type="checkbox" value="emerald" class="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2"/>
...
<script setup lang="ts">
  ...
  import IconMenuAlt2 from "../components/icons/IconMenuAlt2.vue";
</script>
