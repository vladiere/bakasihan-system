    ...
    >
      ...
      <template v-slot:body-cell-actions="props">
        <q-td class="q-mx-sm">
          ...
          >
            <q-tooltip
              ><span v-if="props.row.category_name.toLowerCase() === 'drinks'"
                >Reset</span
              ><span v-else>Delete</span></q-tooltip
            >
          </q-btn>
        </q-td>
      </template>
    ...
    <q-card>
      ...
      <q-card-section>
        ...
        <q-btn
          ...
          icon="mdi-check"
          class="q-mx-sm"
          @click="handleDeleteItems(ID, cat_name)"
        >
...
const handleDeleteItems = async (val_id: number, val_cat_name: string) => {
  loading.value = true;
  await deleteItems({ id: val_id, category_name: val_cat_name })
    .then((response) => {
